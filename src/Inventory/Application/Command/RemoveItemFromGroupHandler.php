...
final class RemoveItemFromGroupHandler
{
    ...
    public function __invoke(RemoveItemFromGroup $command): void
    {
        $group = $this->itemGroups->byId(ItemGroupId::fromString($command->itemGroupId));
        $group->removeItem(InventoryItemId::fromString($command->inventoryItemId), $this->clock);
