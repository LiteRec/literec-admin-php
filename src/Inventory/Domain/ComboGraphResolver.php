 ...
 * 2. Which combos transitively reference this inventory item? (used
 *    for cycle detection — Combo A's validation must reject any
 *    component whose graph eventually points back at A.)
 *
