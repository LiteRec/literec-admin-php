...
use App\Inventory\Domain\Exception\InvalidPurchaseOrderId;
use Stringable;

/**
 * UUID v7 identity for a PurchaseOrder aggregate.
 *
 ...
 */
final readonly class PurchaseOrderId implements Stringable
{
    ...
    private function __construct(string $value)
    {
        if (preg_match(self::UUID_V7_PATTERN, $value) !== 1) {
            throw InvalidPurchaseOrderId::for($value);
        }
