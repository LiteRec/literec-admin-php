...
final class RegisterHouseholdHandler
{
    ...
    public function __invoke(RegisterHousehold $command): HouseholdId
    {
        $name = HouseholdName::of($command->householdName);
        $address = Address::of(
            $command->street,
            $command->unit,
            $command->city,
        ...
        $householdId = $this->ids->nextHouseholdId();
