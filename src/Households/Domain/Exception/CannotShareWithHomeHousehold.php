...
final class CannotShareWithHomeHousehold extends DomainException implements HouseholdsDomainException
{
    /**
    ...
    public static function for(MemberId $memberId, HouseholdId $householdId): self
    {
        ...
        return new self('A member cannot be shared with their own home household.');
    }
}
