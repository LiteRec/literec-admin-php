...
/**
 * Raised when a Role save races a concurrent modification. The Doctrine
 ...
 */
final class ConcurrentRoleModification extends RuntimeException implements AdministrationDomainException
{
    public static function for(string $id, ?Throwable $previous = null): self
    {
        return new self(
            sprintf('Role %s was modified concurrently — reload and retry.', $id),
            0,
            $previous,
        );
    }
