 ...
 *     orphaned or retired-role assignment from being written instead —
 *     it looks the role up through the Roles port and rejects it with
 *     RoleNotFound/RoleIsRetired before Rank::grantRole() is ever called.
