...
use App\Inventory\Domain\Exception\InvalidInventoryItemId;
...
#[Small]
final class InventoryItemIdTest extends TestCase
{
    use UuidV7TestCases;
    ...
    {
        self::assertSame($value, InventoryItemId::fromString($value)->value);
    }

    #[Test]
    #[DataProvider('invalidUuidCases')]
    #[TestDox('Rejects an invalid UUID v7 with InvalidInventoryItemId: $_dataName.')]
    public function rejects_invalid_uuid_v7(string $value): void
    {
        $this->expectException(InvalidInventoryItemId::class);

        InventoryItemId::fromString($value);
    }
    ...
    public function stringifies_to_the_stored_value(): void
    {
        ...
        self::assertSame($value, (string) InventoryItemId::fromString($value));
    }
    ...
    {
        $a = InventoryItemId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $b = InventoryItemId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $c = InventoryItemId::fromString('019571c0-0000-7000-8000-000000000000');
