...
use App\Inventory\Domain\Exception\InvalidStockBatchId;
...
#[Small]
final class StockBatchIdTest extends TestCase
{
    use UuidV7TestCases;
    ...
    {
        self::assertSame($value, StockBatchId::fromString($value)->value);
    }

    #[Test]
    #[DataProvider('invalidUuidCases')]
    #[TestDox('Rejects an invalid UUID v7 with InvalidStockBatchId: $_dataName.')]
    public function rejects_invalid_uuid_v7(string $value): void
    {
        $this->expectException(InvalidStockBatchId::class);

        StockBatchId::fromString($value);
    }
    ...
    public function stringifies_to_the_stored_value(): void
    {
        ...
        self::assertSame($value, (string) StockBatchId::fromString($value));
    }
    ...
    {
        $a = StockBatchId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $b = StockBatchId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $c = StockBatchId::fromString('019571c0-0000-7000-8000-000000000000');
