...
final class UserIdTest extends TestCase
{
    ...
    {
        self::assertSame($value, UserId::fromString($value)->value);
    }
    ...
    #[TestDox('Rejects an invalid UUID v7 with InvalidUserId: $_dataName.')]
    public function rejects_invalid_uuid_v7_with_invalid_user_id(string $value): void
    {
    ...
    public function stringifies_to_the_stored_value(): void
    {
        ...
        self::assertSame($value, (string) UserId::fromString($value));
    }

    #[Test]
    #[TestDox('Equals another UserId with the same value and not-equals when values differ.')]
    public function equals_an_identical_user_id_and_not_equals_a_different_one(): void
    {
        $a = UserId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $b = UserId::fromString('019571bf-5d51-7000-b500-0123456789ab');
        $c = UserId::fromString('019571c0-0000-7000-8000-000000000000');
